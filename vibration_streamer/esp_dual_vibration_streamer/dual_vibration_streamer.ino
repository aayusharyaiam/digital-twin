/*
 * dual_vibration_streamer.ino (ESP32 EDITION)
 * Hardware : ESP32 + MPU6050 (Tip) + MPU6500 (Middle)
...
static const uint8_t MPU_TIP = 0x68;   // MPU6050 (AD0 Open/GND)
...
void setup() {
  // ESP32 has a massive serial buffer, this will fly at 500,000
  Serial.begin(500000);
  while (!Serial) { }

  // Explicitly assign ESP32 I2C pins: SDA = 21, SCL = 22
  Wire.begin(21, 22);
